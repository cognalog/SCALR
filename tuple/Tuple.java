 ...
 * @adapted Kofi Opoku
 * 
 *          This tuple package has been adapted from the JAVATUPLES package
...
public abstract class Tuple implements Iterable<Object>, Serializable,
	 ...
	 *             this level, so use the simpler Tuple(values) constructor
	 *             instead.
	 */
	@Deprecated
	protected Tuple(@SuppressWarnings("unused") final int size,
			final Object... values) {
		super();
